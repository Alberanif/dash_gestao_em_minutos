-- UP: add optional p_offer_code parameter to get_hotmart_metrics RPC
  ...
  select json_build_object(
    'total_sales', (
      ...
      where status = any(array['COMPLETE','APPROVED'])
        ...
        and (p_offer_code is null or offer_code = p_offer_code)
    ),
    'total_sales_brl', (
      select count(*)::int
      from dash_gestao_hotmart_sales
...
-- DOWN: restore previous version without p_offer_code (see 035_hotmart_metrics_rpc.sql)

...
// ── Narrative label ────────────────────────────────────────────────────────
// Adds a subtle chapter marker above each dashboard section,
// giving the user context for what story each section tells.
...
function SectionNarrative({ step, label, desc }: SectionNarrativeProps) {
  return (
    <div
      style={{
        display: "flex",
...
function PeriodControls({
  ...
  onPreset, onStartDate, onEndDate,
}: PeriodControlsProps) {
  return (
...
export default function IndicadoresPage() {
  ...
  useEffect(() => { fetchAll(startDate, endDate); }, [startDate, endDate, fetchAll]);
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <h1 style={{ fontSize: 17, fontWeight: 600, color: "var(--text)", margin: 0, letterSpacing: "-0.015em" }}>
            Indicadores
          </h1>
        </div>
      ...
      <div className="z-layout">
        ...
        <div className="z-row">
          <SectionNarrative
            step="01"
            label="Resultado"
            desc="Desempenho consolidado do período selecionado"
          />
        ...
        {/* ── 02 · JORNADA DE CONVERSÃO ── */}
        {funnelStages && funnelRates && (
          <div className="z-row">
            <SectionNarrative
              step="02"
              label="Jornada de Conversão"
              desc="Do investimento até a venda"
            />
        ...
        <div className="z-row">
          <SectionNarrative
            step="03"
            label="Plataformas"
            desc="Detalhe por fonte de dados"
          />
        ...
        <div className="z-row">
          <SectionNarrative
            ...
            desc="Novos leads que entraram no funil"
          />

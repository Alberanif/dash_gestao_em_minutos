...
import { interpretRefreshResponse, formatRefreshedAgo, type RefreshOutcome } from "@/lib/ultimates/refresh";
...
// POST /api/ultimates/cycles/[id]/refresh — a interpretação da resposta
...
export function RefreshControls({ cycleId, cycleStatus, lastRefreshAt, onRefreshed }: RefreshControlsProps) {
  ...
  async function handleClick() {
    ...
    setFeedback(null);
    try {
      const res = await fetch(`/api/ultimates/cycles/${cycleId}/refresh`, { method: "POST" });

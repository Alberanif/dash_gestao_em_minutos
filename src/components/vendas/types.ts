...
import type { UltimatesCycleRecord, UltimatesCycleProductRef } from "@/types/vendas";

// Espelha UltimatesCycleWithProducts de src/app/api/vendas/cycles/route.ts
...
// Linha da lista devolvida por GET /api/vendas/cycles/[id]/excluded-buyers.

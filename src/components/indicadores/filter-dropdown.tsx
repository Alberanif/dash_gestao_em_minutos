...
// Pure list component — no hooks, fully testable with renderToStaticMarkup
    ...
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && (
        <FilterDropdownList
          ...
          onNew={() => { onNew(); setOpen(false); }}
          onEdit={(f) => { onEdit(f); setOpen(false); }}
          onDelete={(f) => { onDelete(f); setOpen(false); }}
        />
      )}
    </div>
  );

...
function makeRequest(method: string, body?: object): NextRequest {
  return new NextRequest("http://localhost/api/ultimates/cycles/c1/excluded-buyers", {
    method,
...
beforeEach(() => {
  ...
  mockFrom.mockImplementation((table: string) => {
    switch (table) {
      ...
      case "dash_gestao_ultimates_excluded_buyers":
        return {
          select: () => ({ eq: () => ({ order: excludedOrder }) }),
          insert: mockInsert,
          delete: mockDelete,
        };
      case "dash_gestao_ultimates_buyers":
        return {
...
describe("GET /api/ultimates/cycles/[id]/excluded-buyers", () => {
...
describe("POST /api/ultimates/cycles/[id]/excluded-buyers", () => {
...
describe("DELETE /api/ultimates/cycles/[id]/excluded-buyers", () => {

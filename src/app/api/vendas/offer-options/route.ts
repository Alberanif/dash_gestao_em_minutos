...
import type { UltimatesOfferOption, UltimatesOfferlessOption } from "@/types/vendas";
...
export async function GET(request: NextRequest) {
  ...
  const [offersResult, offerlessResult] = await Promise.all([
    supabase.rpc("dash_gestao_vendas_offer_options", { p_product_ids: productIds }),
    supabase.rpc("dash_gestao_vendas_offerless_counts", { p_product_ids: productIds }),
  ]);

...
import type { UltimatesExcludedBuyerRecord } from "@/types/vendas";
 ...
 * dash_gestao_vendas_buyers, nem venda alguma. Quem aplica o efeito são as
...
// grava em dash_gestao_vendas_buyers — por isso as comparações com a base
...
export async function GET(
  ...
  const { data, error: listError } = await supabase
    .from("dash_gestao_vendas_excluded_buyers")
